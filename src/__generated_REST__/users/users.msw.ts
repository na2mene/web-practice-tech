...
export const getCreatePostMock = () =>
...
export const getGetUsersMock = () =>
  Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({
    address: {
      city: faker.helpers.arrayElement([faker.word.sample(), undefined]),
      geo: faker.helpers.arrayElement([
        {
          lat: faker.helpers.arrayElement([faker.word.sample(), undefined]),
          lon: faker.helpers.arrayElement([faker.word.sample(), undefined]),
        },
        undefined,
      ]),
      street: faker.helpers.arrayElement([faker.word.sample(), undefined]),
      suite: faker.helpers.arrayElement([faker.word.sample(), undefined]),
      zipcode: faker.helpers.arrayElement([faker.word.sample(), undefined]),
    },
    company: faker.helpers.arrayElement([
      {
        bs: faker.helpers.arrayElement([faker.word.sample(), undefined]),
        catchPhrase: faker.helpers.arrayElement([faker.word.sample(), undefined]),
...
export const getGetUserCommentsMock = () =>
  Array.from({ length: faker.number.int({ min: 1, max: 10 }) }, (_, i) => i + 1).map(() => ({
